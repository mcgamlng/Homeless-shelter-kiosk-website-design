...
[Unit]
Description=Run Listening House GitHub update every two months

[Timer]
OnCalendar=*-01/2-01 03:30:00
Persistent=true
...
echo "It will run every two months near 3:30 AM, with a small random delay."
