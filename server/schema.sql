...
CREATE TABLE IF NOT EXISTS staff_users (
  ...
  can_admin_excel INTEGER NOT NULL DEFAULT 0,
  can_admin_customization INTEGER NOT NULL DEFAULT 0,
  can_admin_activities INTEGER NOT NULL DEFAULT 0,
  can_admin_it INTEGER NOT NULL DEFAULT 0,
  active INTEGER NOT NULL DEFAULT 1,
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
);
